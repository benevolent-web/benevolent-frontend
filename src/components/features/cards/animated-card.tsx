...
const AnimatedCard: React.FC<{ cardProps: TCardProps }> = ({ cardProps }) => {
  ...
  return (
    <div ref={cardRef} className="relative group bg-none">
      ...
      <div className="relative bg-background/80 backdrop-blur-lg z-[3] rounded-lg overflow-hidden border dark:border-slate-700 border-slate-200">
